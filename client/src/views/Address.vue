    ...
    <i class="iconfont iconicon"></i>
          ...
          <div>
              ...
              <div class="des">
                  ...
                  <span>北京区</span>
				  <!-- {{$store.state.location.addressComponent.district}} -->
              </div>
          </div>
...
export default {
  ...
  methods: {
	  ...
	  changeLocation(index){
		  this.$store.commit("CHANGE_ADDRESS",this.$store.state.location.tips[index].district+this.$store.state.location.tips[index].name+this.$store.state.location.tips[index].address)
		  this.$router.go(-1)
	  }
  }
}
