...
const state = {
	formattedAddress:localStorage.formattedAddress || null,
	tips:[],
}
const mutations = {
	CHANGE_ADDRESS(state,address){
		state.formattedAddress = localStorage.formattedAddress = address;
		// localStorage.province = address.addressComponent.province;
		// localStorage.district = address.addressComponent.district;
		// console.log(state.formattedAddress,state.province,state.district)
	},
